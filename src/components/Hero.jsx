...
const Hero = ({ darkMode }) => {
    ...
    const theme = {
        ...
        decorativeCircle: darkMode ? 'bg-orange-500 opacity-10' : 'bg-orange-400 opacity-20',
    };
            ...
            <section id='home' data-aos='fade-up' data-aos-delay='250' className='body-font z-10'>
                <div className='container mx-auto flex px-4 sm:px-8 lg:px-14 py-12 lg:py-20 flex-col lg:flex-row items-center justify-between lg:mt-0 mt-14'>
                    <div className='lg:h-1/2 w-full flex flex-col items-center lg:items-start mb-12 lg:mb-0'>
                        ...
                        {/* Name */}
                        <h1 className={`title-font text-3xl sm:text-4xl lg:text-5xl mb-4 font-bold pt-7 md:pt-0 text-center lg:text-left ${theme.textPrimary}`}
                        ...
                        <div className='w-full pt-4 sm:pt-6'>
                            <div className='flex flex-col sm:flex-row justify-center lg:justify-start gap-3 sm:gap-4'
                                ...
                                <a href={CV} download className='w-full sm:w-auto'>
                                    <button className='w-full sm:w-auto inline-flex items-center justify-center text-white bg-linear-to-r from-orange-500 to-amber-500 border-0 py-3 px-6 sm:px-8 hover:shadow-[0_0_40px_rgba(249,115,22,0.4)] rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform cursor-pointer active:scale-95'>
                                        <DownloadIcon className='w-4 h-4 sm:h-5 sm:w-5 mr-2'/>
                                        Download CV
                                    </button>
                                </a>
                                <a href="#contact" className='w-full sm:w-auto'>
                                    <button className={`w-full sm:w-auto inline-flex items-center ${theme.buttonSecondary} justify-center border-2 border-orange-500/50 py-3 px-6 sm:px-8 rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform cursor-pointer active:scale-95`}>
                    ...
                    <div className='lg:w-1/2 w-full max-w-md lg:max-w-lg mt-8 lg:mt-0 flex justify-center'
                        ...
                        <div className='relative w-4/5 sm:w-3/4 lg:w-full'>
                            <div className='relative overflow-hidden rounded-2xl'>
                                <img src={hero} alt="Hero" className='w-full h-auto object-cover transform hover:scale-105 transition-transform duration-500'/>
                            </div>
                            <img src={hi} alt="Hi" className='absolute -top-5 left-6 w-14 h-14 sm:w-20 sm:h-20 object-contain animate-bounce opacity-90 z-10'/>
                        </div>
                    </div>
                </div>
