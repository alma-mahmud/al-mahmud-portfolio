                ...
                data-aos-delay='200'>
                    {skills.map((skill, index) => (
                        ...
                        data-aos-delay={`${300 + index * 100}`}>
                            ...
                            duration-300 hover:-translate-y-2 group group-hover:shadow-[0_0_30px_rgb(255,165,0,0.15)]">
                            ...
                            items-center justify-center group-hover:scale-110 transition-transform duration-300">
                                <img
                                src={skill.icon}
                                alt={skill.name}
